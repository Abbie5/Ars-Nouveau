...
import com.hollingsworth.arsnouveau.client.emi.*;
...
//        registration.addRecipeClickArea(CraftingTerminalScreen.class, 100, 125, 28, 23, new RecipeType[] { RecipeTypes.CRAFTING });
    ...
    public void onRuntimeAvailable(IJeiRuntime jeiRuntime) {
        EMIArsNouveauPlugin.jeiRuntime = jeiRuntime;
    }
...
*/
    ...
    public void register(EmiRegistry registry) {
        registry.addRecipeHandler(MenuRegistry.STORAGE.get(), new CraftingTerminalTransferHandler<>());
    }
}